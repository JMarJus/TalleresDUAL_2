...
public class PersonController {
	...
	@Autowired
	public PersonServiceImpl service;
	...
	public String showPeople(Model model) {
		final List<Person> people = service.getAllPeople();
	...
	@Transactional
	public String removePerson(@RequestParam String identityDoc, Model model) {
		service.removePersonByIdentityDoc(identityDoc);
		return showPeople(model);
	}
